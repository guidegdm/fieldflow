...
export function FormPreview() {
  ...
  return (
    <div className="relative mx-auto h-[812px] w-[375px] max-w-[calc(100vw-2rem)] shrink-0 overflow-hidden rounded-[2.5rem] border-4 border-ink-black bg-white shadow-xl">
