...
const adminLinks: NavItem[] = [
  ...
  { label: "Formulaires", href: "/admin/forms", icon: <FileText size={18} /> },
  { label: "Utilisateurs", href: "/admin/users", icon: <Users size={18} /> },
  { label: "Déploiement", href: "/admin/deploy", icon: <Rocket size={18} /> },
  { label: "Audit", href: "/admin/audit", icon: <ScrollText size={18} /> },
...
const supervisorLinks: NavItem[] = [
  ...
  { label: "File d'attente", href: "/supervisor/queue", icon: <Inbox size={18} /> },
  ...
  { label: "Rapports", href: "/supervisor/reports", icon: <BarChart3 size={18} /> },
]
